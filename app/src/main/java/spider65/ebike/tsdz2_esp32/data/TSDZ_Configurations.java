...
public class TSDZ_Configurations {
    ...
    public boolean setData(byte[] data) {
        ...
        if (data[0] == ui8_configurations_version) {
            ...
            ui32_wh_x10_offset = (data[6] & 255) + ((data[7] & 255) << 8) + ((data[8] & 255) << 16) + ((data[9] & 255) << 24);
    ...
    public byte[] toByteArray() {
        ...
        data[19] = (byte) ui8_ramp_up_amps_per_second_x10;
        data[20] = (byte) ui16_battery_low_voltage_cut_off_x10;
        ...
        data[89] = (byte) (ui16_torque_sensor_calibration_table_left[1][1] >> 8);
        data[90] = (byte) (ui16_torque_sensor_calibration_table_left[1][0] & 0xff);
        ...
        data[93] = (byte) (ui16_torque_sensor_calibration_table_left[2][1] >> 8);
        data[94] = (byte) (ui16_torque_sensor_calibration_table_left[2][0] & 0xff);
        ...
        data[97] = (byte) (ui16_torque_sensor_calibration_table_left[3][1] >> 8);
        data[98] = (byte) (ui16_torque_sensor_calibration_table_left[3][0] & 0xff);
        ...
        data[101] = (byte) (ui16_torque_sensor_calibration_table_left[4][1] >> 8);
        data[102] = (byte) (ui16_torque_sensor_calibration_table_left[4][0] & 0xff);
        ...
        data[105] = (byte) (ui16_torque_sensor_calibration_table_left[5][1] >> 8);
        data[106] = (byte) (ui16_torque_sensor_calibration_table_left[5][0] & 0xff);
        ...
        data[109] = (byte) (ui16_torque_sensor_calibration_table_left[6][1] >> 8);
        data[110] = (byte) (ui16_torque_sensor_calibration_table_left[6][0] & 0xff);
        ...
        data[113] = (byte) (ui16_torque_sensor_calibration_table_left[7][1] >> 8);
        data[114] = (byte) (ui16_torque_sensor_calibration_table_left[7][0] & 0xff);
        ...
        data[121] = (byte) (ui16_torque_sensor_calibration_table_right[1][1] >> 8);
        data[122] = (byte) (ui16_torque_sensor_calibration_table_right[1][0] & 0xff);
        ...
        data[125] = (byte) (ui16_torque_sensor_calibration_table_right[2][1] >> 8);
        data[126] = (byte) (ui16_torque_sensor_calibration_table_right[2][0] & 0xff);
        ...
        data[129] = (byte) (ui16_torque_sensor_calibration_table_right[3][1] >> 8);
        data[130] = (byte) (ui16_torque_sensor_calibration_table_right[3][0] & 0xff);
        ...
        data[133] = (byte) (ui16_torque_sensor_calibration_table_right[4][1] >> 8);
        data[134] = (byte) (ui16_torque_sensor_calibration_table_right[4][0] & 0xff);
        ...
        data[137] = (byte) (ui16_torque_sensor_calibration_table_right[5][1] >> 8);
        data[138] = (byte) (ui16_torque_sensor_calibration_table_right[5][0] & 0xff);
        ...
        data[141] = (byte) (ui16_torque_sensor_calibration_table_right[6][1] >> 8);
        data[142] = (byte) (ui16_torque_sensor_calibration_table_right[6][0] & 0xff);
        ...
        data[145] = (byte) (ui16_torque_sensor_calibration_table_right[7][1] >> 8);
        data[146] = (byte) (ui16_torque_sensor_calibration_table_right[7][0] & 0xff);
